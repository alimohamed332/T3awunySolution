...
namespace T3awuny.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260413174239_RemovenullabilityfromAddress")]
    partial class RemovenullabilityfromAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.FarmerProfile", b =>
                {
                    ...
                    b.HasIndex("FarmAddressId")
                        .IsUnique()
                        .HasFilter("[FarmAddressId] IS NOT NULL");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.FarmerProfile", b =>
                {
                    b.HasOne("T3awuny.Core.Entities.Address", "Address")
                        .WithOne()
                        .HasForeignKey("T3awuny.Core.Entities.FarmerProfile", "FarmAddressId")
                        .OnDelete(DeleteBehavior.Cascade);
