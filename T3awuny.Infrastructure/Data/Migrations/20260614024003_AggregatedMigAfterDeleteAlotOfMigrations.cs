...
{
    /// <inheritdoc />
    public partial class AggregatedMigAfterDeleteAlotOfMigrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservePrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentIntentId = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(11,3)", precision: 11, scale: 3, nullable: false),
                    Method = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Card"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ReviewerId_OrderId",
                table: "Reviews",
                columns: new[] { "ReviewerId", "OrderId" },
                unique: true,
