...
namespace T3awuny.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260617202027_AddCommunityAggergationModule")]
    partial class AddCommunityAggergationModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.Comment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.CommentLikes", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.Post", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.PostFile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.PostLike", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.PostShare", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.Comment", b =>
                {
                    b.HasOne("T3awuny.Core.Entities.Community_Aggregation_Module.Comment", null)
                        .WithMany("SubComments")
                        .HasForeignKey("ParentCommentId");

                    b.HasOne("T3awuny.Core.Entities.Community_Aggregation_Module.Post", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("T3awuny.Core.Entities.Community_Aggregation_Module.Post", b =>
                {
                    ...
                    b.HasOne("T3awuny.Core.Entities.UserModule.ApplicationUser", "Publisher")
                        .WithMany()
                        .HasForeignKey("UserId")
